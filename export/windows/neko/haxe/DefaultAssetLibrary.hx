...
@:font("D:/HaxeToolkit/haxe/lib/flixel/3,3,11/assets/fonts/nokiafc22.ttf") @:keep #if display private #end class __ASSET__assets_fonts_nokiafc22_ttf extends flash.text.Font {}
@:font("D:/HaxeToolkit/haxe/lib/flixel/3,3,11/assets/fonts/arial.ttf") @:keep #if display private #end class __ASSET__assets_fonts_arial_ttf extends flash.text.Font {}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/data/stage/level_1.tmx", "assets/data/stage/level_1.tmx");
		type.set ("assets/data/stage/level_1.tmx", AssetType.TEXT);
		path.set ("assets/images/sprite/bullet.png", "assets/images/sprite/bullet.png");
		type.set ("assets/images/sprite/bullet.png", AssetType.IMAGE);
		path.set ("assets/images/sprite/enemy.png", "assets/images/sprite/enemy.png");
		type.set ("assets/images/sprite/enemy.png", AssetType.IMAGE);
		path.set ("assets/images/sprite/player.png", "assets/images/sprite/player.png");
		type.set ("assets/images/sprite/player.png", AssetType.IMAGE);
		path.set ("assets/images/sprite/tile.png", "assets/images/sprite/tile.png");
		type.set ("assets/images/sprite/tile.png", AssetType.IMAGE);
		path.set ("assets/images/tileset.png", "assets/images/tileset.png");
		type.set ("assets/images/tileset.png", AssetType.IMAGE);
		path.set ("assets/images/tileset_block.png", "assets/images/tileset_block.png");
		type.set ("assets/images/tileset_block.png", AssetType.IMAGE);
		...
		id = "assets/data/stage/level_1.tmx";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/sprite/bullet.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/sprite/enemy.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/sprite/player.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/sprite/tile.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tileset.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tileset_block.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
...
@:font("D:/HaxeToolkit/haxe/lib/flixel/3,3,11/assets/fonts/nokiafc22.ttf") #if display private #end class __ASSET__assets_fonts_nokiafc22_ttf extends lime.text.Font {}
@:font("D:/HaxeToolkit/haxe/lib/flixel/3,3,11/assets/fonts/arial.ttf") #if display private #end class __ASSET__assets_fonts_arial_ttf extends lime.text.Font {}
